...
import { CLAVE_EXAMEN, TIEMPO_POR_PREGUNTA, REACTIVOS } from '../../../data/examen-funciones-propositos';
...
export default function ExamenFuncionesPropositos() {
      ...
      >
        ...
        >
          <div style={{ background: C.naranja }} className="px-6 py-7 text-center text-white">
            ...
            <h1 className="text-xl font-extrabold leading-tight">Examen · Funciones y Propósitos</h1>
            <p className="mt-1 text-sm text-white/90">CTE · Artículos 7 y 8 del Acuerdo</p>
          </div>
          ...
          <div className="px-6 py-6">
            ...
            >
              ...
              <ul className="space-y-1">
                <li>• <strong>20 reactivos</strong> sobre los propósitos (Art. 7) y funciones (Art. 8) del CTE.</li>
