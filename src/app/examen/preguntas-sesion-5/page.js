...
import { CLAVE_EXAMEN, TIEMPO_POR_PREGUNTA, REACTIVOS } from '../../../data/examen-sesion-5';
...
export default function ExamenSesion5() {
      ...
      >
        ...
        >
          <div style={{ background: C.naranja }} className="px-6 py-7 text-center text-white">
            ...
            <h1 className="text-xl font-extrabold leading-tight">Preguntas · Sesión 5</h1>
            <p className="mt-1 text-sm text-white/90">SNTE Sección 21 · Sesión 5</p>
          </div>
          ...
          <div className="px-6 py-6">
            ...
            >
              ...
              <ul className="space-y-1">
                <li>• <strong>7 reactivos</strong> de la Sesión 5.</li>
