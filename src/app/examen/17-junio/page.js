...
import { CLAVE_EXAMEN, TIEMPO_POR_PREGUNTA, REACTIVOS } from '../../../data/examen-17-junio';
...
export default function Examen17Junio() {
      ...
      >
        ...
        >
          <div style={{ background: C.naranja }} className="px-6 py-7 text-center text-white">
            ...
            <h1 className="text-xl font-extrabold leading-tight">Examen · 17 de Junio</h1>
            <p className="mt-1 text-sm text-white/90">Banco USICAMM · LGE, LGDNNA y Plan 2022</p>
          </div>
          ...
          <div className="px-6 py-6">
            ...
            >
              ...
              <ul className="space-y-1">
                <li>• <strong>10 reactivos</strong> de LGE, LGDNNA, objetivos NEM y programa analítico.</li>
  ...
  if (fase === 'resultados') {
    ...
    if (porcentaje >= 90) mensaje = '¡Excelente! Dominas estos temas.';
