...
import { CLAVE_EXAMEN, TIEMPO_POR_PREGUNTA, REACTIVOS } from '../../../data/examen-primer-parcial';
...
export default function ExamenPrimerParcial() {
      ...
      >
        ...
        >
          <div style={{ background: C.naranja }} className="px-6 py-7 text-center text-white">
            ...
            <h1 className="text-xl font-extrabold leading-tight">Primer Examen Parcial</h1>
            <p className="mt-1 text-sm text-white/90">Educación Especial + Horas Adicionales · USICAMM</p>
          </div>
          ...
          <div className="px-6 py-6">
            ...
            >
              ...
              <ul className="space-y-1">
                <li>• <strong>30 reactivos</strong> de Educación Especial y Horas Adicionales.</li>
  ...
  if (fase === 'resultados') {
    ...
    if (porcentaje >= 90) mensaje = '¡Excelente! Dominas los temas del parcial.';
    else if (porcentaje >= 70) mensaje = '¡Muy bien! Repasa los reactivos que fallaste.';
